...
const (
    ...
    MetadataTypeData    string  = "dataset"
)
...
type Metadata struct {
    ...
    MIcon            string     `json:"m_icon,omitempty"`
    MLongname        string     `json:"m_longname,omitempty"`
    MManufacturer    string     `json:"m_manufacturer"`
    MPicture         string     `json:"m_picture,omitempty"`
