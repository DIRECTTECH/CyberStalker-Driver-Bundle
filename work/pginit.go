...
const (
    ...
    userId      string = "37955138-964a-40f5-a4e2-4f50d6c06286"
    userLogin   string = "mqttdriver"
    userMName   string = "Pixel MQTT Driver"
    userDesc    string = "Pixel MQTT Driver"  
)
...
func (this *Application) Configure() error {
    ...
    if len(os.Getenv("MQTTDRIVERS_PASSWORD")) == 0 {
        return errors.New("unable set env MQTTDRIVERS_PASSWORD")
    }
    this.userPassword = os.Getenv("MQTTDRIVERS_PASSWORD")
    return err
}
